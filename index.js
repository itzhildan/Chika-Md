...
module.exports = chika = async (chika, m, chatUpdate, store) => {
    try {
		...
		// Reply
        const reply = (teks) => {
            chika.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `${botname}`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": thumb,"sourceUrl": `${mygc}`}}}, { quoted: m })
        }
        // Reply 2
        const replay = (teks) => {
            chika.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `${botname}`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": thumb,"sourceUrl": `${mygc}`}}}, { quoted: m })
...
await chika.send5ButImg(from, `⭔ _*Title :*_ ${cerpe.title}\n⭔ _*Author :*_ ${cerpe.author}\n⭔ _*Category :*_ ${cerpe.kategori}\n⭔ _*Pass Moderation :*_ ${cerpe.lolos}\n⭔ _*Story :*_\n${cerpe.cerita}`, `© ${ownername}`,riych, [{"urlButton": {"displayText": "📜📜KV:RP📜📜","url": `${youtube}`}}] )
}
break
case 'fajar-news':
reply(mess.wait)
...
case 'menu': {
if(typemenu == 'image'){
await chika.send5ButImg(from, `` + '' + lang.menu(botname, pushname, salam), `© ${ownername}`,thumb, [{"urlButton": {"displayText": "👨‍💻YouTube Creator👨‍💻","url": `${youtube}`}},{"urlButton": {"displayText": `📜KV:RP📜`,"url": `${mygc}`}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "List Menu","id": 'command'}}] )
}
if(typemenu == 'gif'){
await chika.send5ButGif(from, `` + '' + lang.menu(botname, pushname, salam), `© ${ownername}`,velochika, [{"urlButton": {"displayText": "👨‍💻YouTube Creator👨‍💻","url": `${youtube}`}},{"urlButton": {"displayText": `📜KV:RP📜`,"url": `${mygc}`}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "List Menu","id": 'command'}}] )
}
if(typemenu == 'list'){
await chika.sendListMenu(from, `Selamat ${salam} kak ${pushname}` , lang.list(pushname) , 'CLICK HERE', {quoted: fkontak})
}
...
await chika.send5ButImg(from, `` + '' + lang.allmenu(prefix, pushname, botname, time, salam), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "👨‍💻YouTube Creator👨‍💻","url": `${youtube}`}},{"urlButton": {"displayText": `📜KV:RP📜`,"url": `${mygc}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}}] )
}
if(typemenu == 'gif'){
await chika.send5ButGif(from, `` + '' + lang.allmenu(prefix, pushname, botname, time, salam), `  © ${ownername}`,velochika, [{"urlButton": {"displayText": "👨‍💻YouTube Creator👨‍💻","url": `${youtube}`}},{"urlButton": {"displayText": `📜KV:RP📜`,"url": `${mygc}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}}] )
}
if(typemenu == 'catalog'){
...
await chika.send5ButImg(from, `` + '' + lang.groupmenu(prefix), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "👨‍💻YouTube Creator👨‍💻","url": `${youtube}`}},{"urlButton": {"displayText": `📜KV:RP📜`,"url": `${mygc}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'downloadermenu':
var riych = await getBuffer(picak+'Downloader Menu')
await chika.send5ButImg(from, `` + '' + lang.downloadermenu(prefix), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "👨‍💻YouTube Creator👨‍💻","url": `${youtube}`}},{"urlButton": {"displayText": `📜KV:RP📜`,"url": `${mygc}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'searchmenu':
var riych = await getBuffer(picak+'Search Menu')
await chika.send5ButImg(from, `` + '' + lang.searchmenu(prefix), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "👨‍💻YouTube Creator👨‍💻","url": `${youtube}`}},{"urlButton": {"displayText": `📜KV:RP📜`,"url": `${mygc}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'telestickmenu':
var riych = await getBuffer(picak+'Telegram Sticker Menu')
await chika.send5ButImg(from, `` + '' + lang.telestickmenu(prefix), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "👨‍💻YouTube Creator👨‍💻","url": `${youtube}`}},{"urlButton": {"displayText": `📜KV:RP📜`,"url": `${mygc}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'randommenu':
var riych = await getBuffer(picak+'Random Menu')
await chika.send5ButImg(from, `` + '' + lang.randommenu(prefix), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "👨‍💻YouTube Creator👨‍💻","url": `${youtube}`}},{"urlButton": {"displayText": `📜KV:RP📜`,"url": `${mygc}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'randomanimemenu':
var riych = await getBuffer(picak+'Random Anime Menu')
await chika.send5ButImg(from, `` + '' + lang.randomanimemenu(prefix), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "👨‍💻YouTube Creator👨‍💻","url": `${youtube}`}},{"urlButton": {"displayText": `📜KV:RP📜`,"url": `${mygc}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'searchmenu':
var riych = await getBuffer(picak+'Search Menu')
await chika.send5ButImg(from, `` + '' + lang.searchmenu(prefix), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "👨‍💻YouTube Creator👨‍💻","url": `${youtube}`}},{"urlButton": {"displayText": `📜KV:RP📜`,"url": `${mygc}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
...
await chika.send5ButImg(from, `` + '' + lang.textpromenu(prefix), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "👨‍💻YouTube Creator👨‍💻","url": `${youtube}`}},{"urlButton": {"displayText": `📜KV:RP📜`,"url": `${mygc}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'photooxymenu':
var riych = await getBuffer(picak+'Photo Oxy Menu')
await chika.send5ButImg(from, `` + '' + lang.photooxymenu(prefix), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "👨‍💻YouTube Creator👨‍💻","url": `${youtube}`}},{"urlButton": {"displayText": `📜KV:RP📜`,"url": `${mygc}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'ephotomenu':
var riych = await getBuffer(picak+'Ephoto Menu')
await chika.send5ButImg(from, `` + '' + lang.ephotomenu(prefix), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "👨‍💻YouTube Creator👨‍💻","url": `${youtube}`}},{"urlButton": {"displayText": `📜KV:RP📜`,"url": `${mygc}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'funmenu':
var riych = await getBuffer(picak+'Fun Menu')
await chika.send5ButImg(from, `` + '' + lang.funmenu(prefix), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "👨‍💻YouTube Creator👨‍💻","url": `${youtube}`}},{"urlButton": {"displayText": `📜KV:RP📜`,"url": `${mygc}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'primbonmenu':
var riych = await getBuffer(picak+'Primbon Menu')
await chika.send5ButImg(from, `` + '' + lang.primbonmenu(prefix), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "👨‍💻YouTube Creator👨‍💻","url": `${youtube}`}},{"urlButton": {"displayText": `📜KV:RP📜`,"url": `${mygc}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'cerpenmenu':
var riych = await getBuffer(picak+'Cerpen Menu')
await chika.send5ButImg(from, `` + '' + lang.cerpenmenu(prefix), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "👨‍💻YouTube Creator👨‍💻","url": `${youtube}`}},{"urlButton": {"displayText": `📜KV:RP📜`,"url": `${mygc}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'convertmenu':
var riych = await getBuffer(picak+'Converter Menu')
await chika.send5ButImg(from, `` + '' + lang.convertmenu(prefix), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "👨‍💻YouTube Creator👨‍💻","url": `${youtube}`}},{"urlButton": {"displayText": `📜KV:RP📜`,"url": `${mygc}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'informationmenu':
var riych = await getBuffer(picak+'Information Menu')
await chika.send5ButImg(from, `` + '' + lang.informationmenu(prefix), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "👨‍💻YouTube Creator👨‍💻","url": `${youtube}`}},{"urlButton": {"displayText": `📜KV:RP📜`,"url": `${mygc}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'mainmenu':
var riych = await getBuffer(picak+'Main Menu')
await chika.send5ButImg(from, `` + '' + lang.mainmenu(prefix), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "👨‍💻YouTube Creator👨‍💻","url": `${youtube}`}},{"urlButton": {"displayText": `📜KV:RP📜`,"url": `${mygc}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'databasemenu':
...
await chika.send5ButImg(from, `` + '' + lang.anonymousmenu(prefix), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "👨‍💻YouTube Creator👨‍💻","url": `${youtube}`}},{"urlButton": {"displayText": `📜KV:RP📜`,"url": `${mygc}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'islamicmenu':
var riych = await getBuffer(picak+'Islamic Menu')
await chika.send5ButImg(from, `` + '' + lang.islamicmenu(prefix), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "👨‍💻YouTube Creator👨‍💻","url": `${youtube}`}},{"urlButton": {"displayText": `📜KV:RP📜`,"url": `${mygc}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'voicechargermenu':
var riych = await getBuffer(picak+'Voice Charger Menu')
await chika.send5ButImg(from, `` + '' + lang.voicechargermenu(prefix), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "👨‍💻YouTube Creator👨‍💻","url": `${youtube}`}},{"urlButton": {"displayText": `📜KV:RP📜`,"url": `${mygc}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'ownermenu':
var riych = await getBuffer(picak+'Owner Menu')
await chika.send5ButImg(from, `` + '' + lang.ownermenu(prefix), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "👨‍💻YouTube Creator👨‍💻","url": `${youtube}`}},{"urlButton": {"displayText": `📜KV:RP📜`,"url": `${mygc}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'donasi': case 'donate':
var riych = await getBuffer(picak+'Donasi')
await chika.send5ButImg(from, `` + '' + lang.donasi(ownernomer), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "👨‍💻YouTube Creator👨‍💻","url": `${youtube}`}},{"urlButton": {"displayText": `📜KV:RP📜`,"url": `${mygc}`}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
case 'thanksto': case 'tqto':
var riych = await getBuffer(picak+'Contributors')
await chika.send5ButImg(from, `` + '' + lang.thanksto(), `  © ${ownername}`,riych, [{"urlButton": {"displayText": "👨‍💻YouTube Creator👨‍💻","url": `${youtube}`}},{"urlButton": {"displayText": `📜KV:RP📜`,"url": `${mygc}`}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Back List","id": 'command'}}] )
break
             default:
                if (budy.startsWith('=>')) {
                    if (!isCreator) return reply(mess.owner)
